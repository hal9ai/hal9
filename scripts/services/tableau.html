...
<div>
  <h2>Step 1</h2>
  <p>
    Export your data from <a href="https://www.tableau.com/tableau-login-hub" target="_blank">Tableau</a> as a CSV file.
  </p>


  <h2>Step 2</h2>
  <p>
    Import your CSV file from Tableau here:
  </p>
...
<script>
  ...
  **/
  ...
  if (!hal9.isDocument()) {
    ...
    html.querySelector('.tableau').innerHTML = ''
  }
</script>
