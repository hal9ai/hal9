/**
  output: [html]
  description: Visualize the contributions to a flow by with arrows who's widths are propotional to volume
  params:
    - name: source
      label: Source
      single: true
      description: The column containing the source nodes
      static: false
    - name: target
      label: Target
      single: true
      description: The column containing the target nodes
      static: false
    - name: value
      label: Value
      description: The column containing the volume of each arrow
      static: false
    - name: palette
      label: D3 Palette
    ...
    - name: marginleft
      label: Margin left
      description: The margin on the left
      value:
        - control: range
          value: 40
          min: 0
          max: 200
    - name: marginbottom
      description: The margin on the bottom
      label: Margin Bottom
      value:
        - control: range
          value: 10
