...
async def save_to_png(description: str, save_path: str = './output-files/screenshot.png'):
    ...
    """ 
        # switch to BrowserContext.take_screenshot() as soon as viable
        ...
        print(decoded_bytes)
        print()
        # Action error: Error executing action save_to_png: 'utf-8' codec can't decode byte 0x89 in position 0: invalid start byte
        print(decoded_str)
    """
