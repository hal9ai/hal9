...
<center><img src="tutorial_0/65.png" style="max-width: 70%"/></center>

Immediately after selecting our csv file, the data will be displayed in a table and then we can introduce prompts and describe the app we want to build as we did before.

<center><img src="tutorial_0/6.gif" style="max-width: 70%"/></center>
