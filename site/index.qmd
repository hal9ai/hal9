...
The next two examples make use of controls, visualizations, and transforamtions that showcase [filtering](#filtering) and [sampling](#sampling) directly in your browser.
...
We are adding support to perform complex Python and R based operations with server-side frameworks like [Bussin](), [Shiny]() and [Streamlit]().
