...
You may start building your own pipeline interactively using the `hal9` function:
...
You may export an existing pipeline built using high level function to a html file using the `hal9_render` function:
...
You can also publish your work on RPubs to make it easily shareable through a link:
