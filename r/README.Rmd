...
knitr::include_graphics("https://raw.githubusercontent.com/hal9ai/hal9ai/main/r/inst/htmlwidgets/scatter_example.png")
```
...
```{r, eval = TRUE, echo = FALSE, out.width="50%", fig.align="center"}
knitr::include_graphics("inst/htmlwidgets/scatter_example.png")
```
