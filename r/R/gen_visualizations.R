...
#' @export
#'
h9_bubble_chart <- function(h = NULL, label  = NULL, size  = NULL, palette  = NULL, ...) {
...
#' @export
#'
h9_facets_chart <- function(h = NULL, x  = NULL, y  = NULL, facets  = NULL, color  = NULL, chartType  = NULL, palette  = NULL, ...) {
  if (identical(h, NULL)) h <- h9_default()
...
#' @export
#'
h9_funnel_chart <- function(h = NULL, stage  = NULL, value  = NULL, label  = NULL, fontSize  = NULL, showPercentSelection  = NULL, funnelType  = NULL, palette  = NULL, ...) {
  if (identical(h, NULL)) h <- h9_default()
...
#' @export
#'
h9_map_chart <- function(h = NULL, lon  = NULL, lat  = NULL, size  = NULL, label  = NULL, ...) {
  if (identical(h, NULL)) h <- h9_default()
...
#' @export
#'
h9_network_chart <- function(h = NULL, from  = NULL, to  = NULL, ...) {
  if (identical(h, NULL)) h <- h9_default()
...
#' @export
#'
h9_plotly_chart <- function(h = NULL, x  = NULL, y  = NULL, chartType  = NULL, dataSizes  = NULL, palette  = NULL, ...) {
  if (identical(h, NULL)) h <- h9_default()
...
#' @export
#'
h9_radial_chart <- function(h = NULL, x  = NULL, y  = NULL, wafflesizelabel  = NULL, palette  = NULL, ...) {
  if (identical(h, NULL)) h <- h9_default()
...
#' @export
#'
h9_regression_chart <- function(h = NULL, x  = NULL, y  = NULL, type  = NULL, predictions  = NULL, ...) {
  if (identical(h, NULL)) h <- h9_default()
...
#' @export
#'
h9_waffle_chart <- function(h = NULL, x  = NULL, y  = NULL, wafflesizelabel  = NULL, palette  = NULL, ...) {
  if (identical(h, NULL)) h <- h9_default()
...
#' @export
#'
h9_waterfall_chart <- function(h = NULL, x  = NULL, y  = NULL, fontsize  = NULL, marginleft  = NULL, marginbottom  = NULL, ...) {
  if (identical(h, NULL)) h <- h9_default()
...
#' @export
#'
h9_wordcloud_chart <- function(h = NULL, label  = NULL, size  = NULL, ...) {
  if (identical(h, NULL)) h <- h9_default()
